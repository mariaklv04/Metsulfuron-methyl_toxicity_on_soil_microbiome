...
if [ "$#" -ne 5 ]; then
	...
	echo "Bacteria_MK_Microcosms_Metsulfuron_methyl_001	TTCTTCTTCGTGTG"
	echo "Bacteria_MK_Microcosms_Metsulfuron_methyl_002	TTCTCAATGGTGTG"
	echo "Bacteria_MK_Microcosms_Metsulfuron_methyl_003	TTCAGTTCAGTGTG"
	echo "...	..."
	echo " "
	echo "CRITICAL!!!"
