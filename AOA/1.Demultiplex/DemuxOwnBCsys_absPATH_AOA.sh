...
if [ "$#" -ne 5 ]; then
	...
	echo "AOA_MK_Microcosms_Metsulfuron_methyl_001	ATTACCGGGTGGATAC"
	echo "AOA_MK_Microcosms_Metsulfuron_methyl_002	ATTAGGCGGTGGATAC"
	echo "AOA_MK_Microcosms_Metsulfuron_methyl_003	ATACTCCGGTGGATAC"
	echo "...	..."
	echo " "
	echo "CRITICAL!!!"
