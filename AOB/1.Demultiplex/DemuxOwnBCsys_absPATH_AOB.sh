...
if [ "$#" -ne 5 ]; then
	...
	echo "AOB_MK_Microcosms_Metsulfuron_methyl_001	TATTACGCAAGGGGTTTCTACTGGTG"
	echo "AOB_MK_Microcosms_Metsulfuron_methyl_002	TATTCGTCAAGGGGTTTCTACTGGTG"
	echo "AOB_MK_Microcosms_Metsulfuron_methyl_003	TATATGGCAAGGGGTTTCTACTGGTG"
	echo "...	..."
	echo " "
	echo "CRITICAL!!!"
